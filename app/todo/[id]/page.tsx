      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 mb-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-sm sm:text-base font-semibold text-purple-200 uppercase tracking-wide">Status</span>
            <StatusBadge completed={todo.completed} />
          </div>
            <div className="pt-4 border-t border-white/10">
              <span className="text-sm sm:text-base font-semibold text-purple-200 uppercase tracking-wide block mb-2">Created</span>
